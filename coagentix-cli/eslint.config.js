// ESLint flat config for coagentix-cli (Node CLI, no framework-specific rules needed).
...
// typeof X` pattern) or unrelated to this config's actual goal (catching genuinely-dead local
// code). Scope is intentionally the unused-vars family + @typescript-eslint's own recommended
// TS rules.
