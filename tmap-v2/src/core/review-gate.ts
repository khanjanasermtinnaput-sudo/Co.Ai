...
// This is the Coagentix AI self-correction layer that ensures quality before delivery.

import type { LLMCall, QualityScore, TaskCategory } from '../types.js';
import { categoryLabel } from './classifier.js';

const REVIEWER_SYS = `You are the Quality Review Agent in Coagentix AI.
