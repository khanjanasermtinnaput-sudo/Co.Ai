...
const TITAN_SYS = `You are Coagentix Titan — the highest-level planning and architecture mode in Coagentix Code.
...
const REVISION_SYS = `You are Coagentix Titan revising your own plan after a multi-pass self review.
